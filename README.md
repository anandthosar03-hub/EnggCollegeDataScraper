# EnggCollegeDataScraper
🎓 Engineering College Information Scraper is a Python 🐍 GUI app that collects data on Indian engineering colleges. 🔍 Search by state, branch &amp; type, 🌐 scrape websites automatically, and 📊 export structured results to Excel. 🖥️ Built with Tkinter, Selenium &amp; Pandas.
